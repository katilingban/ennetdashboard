...
daily_interactions <- get_db_topics_daily_interactions()

## Process weeklies topics data
weekly_interactions <- get_db_topics_weekly_interactions()

## Process monthlies topics data
monthly_interactions <- get_db_topics_monthly_interactions()

## Process yearlies topics data
yearly_interactions <- get_db_topics_yearly_interactions()
```
